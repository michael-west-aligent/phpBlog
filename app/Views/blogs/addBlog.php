...
<div class="card card-body bg light mt-5">
    ...
    <form action="/blog/addBlog" method="post">
        <div class="form-group">
            ...
            <input value="<?php echo !empty($this->params['title']) ? $this->params['title'] : ''; ?>" type="text" name="title" class="form-control form-control-lg">
        </div>
        ...
        <div class="form-group">
            ...
            <textarea name="blog_body" class="form-control form-control-lg" <?php echo (!empty($this->params
                ['error_message']) && ($this->params['error_message'] != '')) ? 'is-invalid' : ''; ?>
